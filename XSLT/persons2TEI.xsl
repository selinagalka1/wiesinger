...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
            ...
            <teiHeader>
                <fileDesc>
                    ...
                    <publicationStmt>
                        ...
                        <idno type="PID">o:wiesinger.persons</idno>
                    </publicationStmt>
                    <sourceDesc>
                        <p>Personenregister, born digital</p>
                    </sourceDesc>
                </fileDesc>
                <encodingDesc>
                    <projectDesc>
    ...
    <xsl:template match="t:row">
        <xsl:for-each select=".">
            <person>
                ...
                <xsl:if test="t:cell[5]/t:ptr">
                    <idno source="https://viaf.org" type="URI">
                        <xsl:value-of select="t:cell[5]/t:ptr/@target"/>
                    </idno>
                </xsl:if>
                <xsl:if test="t:cell[6]/t:ptr">
                    <idno source="https://wikipedia.org" type="URI">
                        <xsl:value-of select="t:cell[6]/t:ptr/@target"/>
                    </idno>
    ...
    <xsl:template name="index">
        ...
        <xsl:if test="$tagebuch_1961//t:persName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1961//t:persName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
                        <xsl:value-of
                            select="concat('http://gams.uni-graz.at/o:wiesinger.1961#', .)"/>
                    </xsl:attribute>
            ...
            <!-- <xsl:text> (</xsl:text>
                <xsl:for-each-group select="$tagebuch_1961//t:persName[@corresp = $ID]"
                    group-by="@corresp">
        ...
        <xsl:if test="$tagebuch_1962//t:persName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1962//t:persName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
                        <xsl:value-of
                            select="concat('http://gams.uni-graz.at/o:wiesinger.1962#', .)"/>
                    </xsl:attribute>
                    <xsl:attribute name="ana">
                        <xsl:value-of select="parent::t:pb/@n"/>
                    </xsl:attribute>
        ...
        <xsl:if test="$tagebuch_1963//t:persName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1963//t:persName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
                        <xsl:value-of
                            select="concat('http://gams.uni-graz.at/o:wiesinger.1963#', .)"/>
                    </xsl:attribute>
                    <xsl:attribute name="ana">
                        <xsl:value-of select="parent::t:pb/@n"/>
                    </xsl:attribute>
        ...
        <xsl:if test="$tagebuch_1964//t:persName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1964//t:persName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
                        <xsl:value-of
                            select="concat('http://gams.uni-graz.at/o:wiesinger.1964#', .)"/>
                    </xsl:attribute>
                    <xsl:attribute name="ana">
                        <xsl:value-of select="parent::t:pb/@n"/>
                    </xsl:attribute>
        ...
        <xsl:if test="$tagebuch_1965//t:persName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1965//t:persName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
                        <xsl:value-of
                            select="concat('http://gams.uni-graz.at/o:wiesinger.1965#', .)"/>
                    </xsl:attribute>
                    <xsl:attribute name="ana">
                        <xsl:value-of select="parent::t:pb/@n"/>
                    </xsl:attribute>
        ...
        <xsl:if test="$tagebuch_1966//t:persName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1966//t:persName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
                        <xsl:value-of
                            select="concat('http://gams.uni-graz.at/o:wiesinger.1966#', .)"/>
                    </xsl:attribute>
                    <xsl:attribute name="ana">
                        <xsl:value-of select="parent::t:pb/@n"/>
                    </xsl:attribute>
        ...
        <xsl:if test="$tagebuch_1967//t:persName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1967//t:persName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
                        <xsl:value-of
                            select="concat('http://gams.uni-graz.at/o:wiesinger.1967#', .)"/>
                    </xsl:attribute>
                    <xsl:attribute name="ana">
                        <xsl:value-of select="parent::t:pb/@n"/>
                    </xsl:attribute>
        ...
        <xsl:if test="$tagebuch_1968//t:persName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1968//t:persName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
                        <xsl:value-of
                            select="concat('http://gams.uni-graz.at/o:wiesinger.1968#', .)"/>
                    </xsl:attribute>
                    <xsl:attribute name="ana">
                        <xsl:value-of select="parent::t:pb/@n"/>
                    </xsl:attribute>
        ...
        <xsl:if test="$tagebuch_1969//t:persName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1969//t:persName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
                        <xsl:value-of
                            select="concat('http://gams.uni-graz.at/o:wiesinger.1969#', .)"/>
                    </xsl:attribute>
                    <xsl:attribute name="ana">
                        <xsl:value-of select="parent::t:pb/@n"/>
                    </xsl:attribute>
        ...
        <xsl:if test="$tagebuch_1970//t:persName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1970//t:persName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
                        <xsl:value-of
                            select="concat('http://gams.uni-graz.at/o:wiesinger.1970#', .)"/>
                    </xsl:attribute>
                    <xsl:attribute name="ana">
                        <xsl:value-of select="parent::t:pb/@n"/>
                    </xsl:attribute>
        ...
        <xsl:if test="$tagebuch_1971//t:persName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1971//t:persName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
                        <xsl:value-of
                            select="concat('http://gams.uni-graz.at/o:wiesinger.1971#', .)"/>
                    </xsl:attribute>
                    <xsl:attribute name="ana">
                        <xsl:value-of select="parent::t:pb/@n"/>
                    </xsl:attribute>
        ...
        <xsl:if test="$tagebuch_1972//t:persName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1972//t:persName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
                        <xsl:value-of
                            select="concat('http://gams.uni-graz.at/o:wiesinger.1972#', .)"/>
                    </xsl:attribute>
                    <xsl:attribute name="ana">
                        <xsl:value-of select="parent::t:pb/@n"/>
                    </xsl:attribute>
        ...
        <xsl:if test="$tagebuch_1973//t:persName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1973//t:persName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
                        <xsl:value-of
                            select="concat('http://gams.uni-graz.at/o:wiesinger.1973#', .)"/>
                    </xsl:attribute>
                    <xsl:attribute name="ana">
                        <xsl:value-of select="parent::t:pb/@n"/>
                    </xsl:attribute>
