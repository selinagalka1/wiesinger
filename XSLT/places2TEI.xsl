...
<!-- generiert teiHeader -->
            ...
            <teiHeader>
                <fileDesc>
                    ...
                    <publicationStmt>
                        ...
                        <idno type="PID">o:wiesinger.places</idno>
                    </publicationStmt>
                    <sourceDesc>
                        <p>Ortsregister, born digital</p>
                    </sourceDesc>
                </fileDesc>
                <encodingDesc>
                    <projectDesc>
    ...
    <cell>GeoNames</cell> [3]
    <cell>Koordinaten</cell> [4]
    <cell>Link</cell> [5]
    <cell>Kategorie</cell> [6]
    <cell>Zusatzinfo</cell> [7]
    
    Der Text wird aus den Zellen transformiert und in einem TEI-Modell ausgegeben.
    -->
        ...
        <xsl:for-each select=".">
            <place>
                ...
                <xsl:if test="t:cell[3]/t:ptr">
                    <idno source="https://www.geonames.org" type="URI">
                ...
                <xsl:if test="t:cell[7] != ''">
                    <note>
                        <xsl:value-of select="t:cell[7]"/><!-- Zusatzinfo/Kommetar -->
                    </note>
    ...
    <xsl:template name="index">
        ...
        <xsl:if test="$tagebuch_1961//t:placeName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1961//t:placeName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
            ...
            <!-- <xsl:text> (</xsl:text>
                <xsl:for-each-group select="$tagebuch_1961//t:placeName[@corresp = $ID]"
                    group-by="@corresp">
        ...
        <xsl:if test="$tagebuch_1962//t:placeName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1962//t:placeName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
        ...
        <xsl:if test="$tagebuch_1963//t:placeName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1963//t:placeName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
        ...
        <xsl:if test="$tagebuch_1964//t:placeName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1964//t:placeName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
        ...
        <xsl:if test="$tagebuch_1965//t:placeName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1965//t:placeName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
        ...
        <xsl:if test="$tagebuch_1966//t:placeName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1966//t:placeName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
        ...
        <xsl:if test="$tagebuch_1967//t:placeName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1967//t:placeName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
        ...
        <xsl:if test="$tagebuch_1968//t:placeName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1968//t:placeName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
        ...
        <xsl:if test="$tagebuch_1969//t:placeName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1969//t:placeName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
        ...
        <xsl:if test="$tagebuch_1970//t:placeName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1970//t:placeName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
        ...
        <xsl:if test="$tagebuch_1971//t:placeName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1971//t:placeName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
        ...
        <xsl:if test="$tagebuch_1972//t:placeName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1972//t:placeName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
        ...
        <xsl:if test="$tagebuch_1973//t:placeName/substring-after(@ref, '#') = $ID">
            <xsl:for-each
                select="$tagebuch_1973//t:placeName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
                <ptr>
                    <xsl:attribute name="target">
