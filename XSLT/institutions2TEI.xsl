...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="t:TEI">
    <TEI xmlns="http://www.tei-c.org/ns/1.0" xml:lang="de">
      <teiHeader>
        <fileDesc>
          <titleStmt>
            <title type="main">Institutionenregister</title>
          ...
          <publicationStmt>
            ...
            <idno type="PID">o:wiesinger.institutions</idno>
          </publicationStmt>
          <sourceDesc>
            <p>Institutionenregister, born digital</p>
          </sourceDesc>
        </fileDesc>
        <encodingDesc>
          <projectDesc>
  ...
  <!--   
    <cell>ID</cell> [1]
    <cell>Bezeichnung</cell> [2]
    <cell>Abkürzung</cell> [3]
    <cell>GND</cell> [4]
    <cell>VIAF</cell> [5]
    <cell>Link</cell> [6]
    <cell>Kategorie</cell> [7]
    <cell>Zusatzinfo</cell> [8]
    
    Der Oxgarage-Output von Excel nach TEI wird in ein TEI-Modell übertragen. 
    Das Element <org> erhält die XML-ID aus Zelle 1 des Oxgarage-Outputs.
    Zelle 2 kommt in ein <orgName>, Zelle 3 in ein <orgName type="alt">.
    Zellen 4-6 enhalten Normdaten, die jeweils in ein <idno type="..."> transformiert werden.
...
-->
  ...
  <xsl:template name="index">
    ...
    <xsl:if test="$tagebuch_1961//t:orgName/substring-after(@ref, '#') = $ID">
      <xsl:for-each
        select="$tagebuch_1961//t:orgName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
        <ptr>
      ...
      <!-- <xsl:text> (</xsl:text>
                <xsl:for-each-group select="$tagebuch_1961//t:orgName[@corresp = $ID]"
                    group-by="@corresp">
    ...
    <xsl:if test="$tagebuch_1962//t:orgName/substring-after(@ref, '#') = $ID">
      <xsl:for-each
        select="$tagebuch_1962//t:orgName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
        <ptr>
          <xsl:attribute name="target">
    ...
    <xsl:if test="$tagebuch_1963//t:orgName/substring-after(@ref, '#') = $ID">
      <xsl:for-each
        select="$tagebuch_1963//t:orgName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
        <ptr>
          <xsl:attribute name="target">
    ...
    <xsl:if test="$tagebuch_1964//t:orgName/substring-after(@ref, '#') = $ID">
      <xsl:for-each
        select="$tagebuch_1964//t:orgName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
        <ptr>
          <xsl:attribute name="target">
    ...
    <xsl:if test="$tagebuch_1965//t:orgName/substring-after(@ref, '#') = $ID">
      <xsl:for-each
        select="$tagebuch_1965//t:orgName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
        <ptr>
          <xsl:attribute name="target">
    ...
    <xsl:if test="$tagebuch_1966//t:orgName/substring-after(@ref, '#') = $ID">
      <xsl:for-each
        select="$tagebuch_1966//t:orgName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
        <ptr>
          <xsl:attribute name="target">
    ...
    <xsl:if test="$tagebuch_1967//t:orgName/substring-after(@ref, '#') = $ID">
      <xsl:for-each
        select="$tagebuch_1967//t:orgName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
        <ptr>
          <xsl:attribute name="target">
    ...
    <xsl:if test="$tagebuch_1968//t:orgName/substring-after(@ref, '#') = $ID">
      <xsl:for-each
        select="$tagebuch_1968//t:orgName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
        <ptr>
          <xsl:attribute name="target">
    ...
    <xsl:if test="$tagebuch_1969//t:orgName/substring-after(@ref, '#') = $ID">
      <xsl:for-each
        select="$tagebuch_1969//t:orgName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
        <ptr>
          <xsl:attribute name="target">
    ...
    <xsl:if test="$tagebuch_1970//t:orgName/substring-after(@ref, '#') = $ID">
      <xsl:for-each
        select="$tagebuch_1970//t:orgName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
        <ptr>
          <xsl:attribute name="target">
    ...
    <xsl:if test="$tagebuch_1971//t:orgName/substring-after(@ref, '#') = $ID">
      <xsl:for-each
        select="$tagebuch_1971//t:orgName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
        <ptr>
          <xsl:attribute name="target">
    ...
    <xsl:if test="$tagebuch_1972//t:orgName/substring-after(@ref, '#') = $ID">
      <xsl:for-each
        select="$tagebuch_1972//t:orgName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
        <ptr>
          <xsl:attribute name="target">
    ...
    <xsl:if test="$tagebuch_1973//t:orgName/substring-after(@ref, '#') = $ID">
      <xsl:for-each
        select="$tagebuch_1973//t:orgName[substring-after(@ref, '#') = $ID]/preceding::t:pb[1]/@xml:id">
        <ptr>
          <xsl:attribute name="target">
